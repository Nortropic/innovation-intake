# Brainstorming och arbetsflöden — fullständigt transkript

**Källprojekt:** Improvements (ChatGPT-projekt)
**Chatt:** Brainstorming och arbetsflöden
...
**Syfte:** Brainstorm om arbetsflöden för brainstorming och hur intake-skillen bär resultatet vidare.

**Innehåll i korthet:** Samtalet öppnar med: ”Jag vill brainstorma vidare kring arbetsflöden/workflows. Hur arbetar man från chattande till implementation på openai, anthropic och andra framstående inom programmering och utvec” och avslutas med: ”Ja. Och eftersom du redan har **en skill som kan föra hela brainstorm-chatten in i Claude Code**, tycker jag att vi kan tänka betydligt mer ambitiöst än bara “chat → prompt → kod”.”
