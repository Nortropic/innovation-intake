# Arbetsmetoder för innovation — fullständigt transkript

**Källprojekt:** Improvements (ChatGPT-projekt)
**Chatt:** Arbetsmetoder för innovation
...
**Syfte:** Brainstorm om arbetsmetoder för innovation, bl.a. Deep Brainstorm som standardläge.

**Innehåll i korthet:** Samtalet öppnar med: ”När jag ska brainstorma så brukar jag skriva saker som Websearcha, best practices, think hard, iterate men är det praxis att göra så? Hur arbetar man på openai, anthropic när man s” och avslutas med: ”Ja. Då sätter vi **Deep Brainstorm som standardläge varje gång**. Det betyder att när du framöver skriver exempelvis: > Brainstorma kring detta… så går jag automatiskt på full proc”
