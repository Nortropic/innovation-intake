# Brainstorma Nortropic Engineering — fullständigt transkript

**Källprojekt:** Improvements (ChatGPT-projekt)
**Chatt:** Brainstorma Nortropic Engineering
...
**Syfte:** Brainstorm om Nortropics context-, memory- och harness-engineering och hur modellen håller under stresstest.

**Innehåll i korthet:** Samtalet öppnar med: ”Täcker Nortropic context, memory och harness engineering, brainstorma” och avslutas med: ”Ja. När jag stress-testar modellen från förra svaret tycker jag att **vi fortfarande saknar några saker**. Framför allt skulle jag lägga till **Objective/Specification Engineering*”
